...
public class Loading_1 extends javax.swing.JFrame {
   ...
   // Timer ekk danwa pbr bar ekt
    Timer timer;
    //timer ekedi pennana veriable hadnna
    int count = 1;
    public Loading_1() {
        initComponents();
        //Screen eke center karnna
        ...
        timer = new Timer(100, new ActionListener() {
          ...
          // timer ekedi wennda oni ewa
                pbr.setValue(count++);
                //lbl eke value pennanna
                lbl_loading.setText(count+"%");  //lbl eke value % pennnna
                if (count == 100){
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/open.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                ...
                .addComponent(pbr, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
